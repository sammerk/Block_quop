...
::: {.column width='40%'}
Bevor man eine Variable erfassen kann, gilt es diese möglichst klar zu operationalsieren [@doering2016] - nur so kann es zu einer konstruktvaliden [@cronbach1955] Erfassung kommen. Im Falle der Lesekompetenz wird oft auf das Modell von Rosebrock und Nix  -@lenhard2019 zurückgegriffen.
...
* **Leseflüssigkeit** 
    * Anzahl richtig gelesener Wörter minus falsch gelesener Wörter geteilt pro Minute
    * Prosodie
